...
export default function About() {
    return(
        ...
        <div id="about" className="flex gap-6">
            <div className="overlay_about1 flex flex-col w-[400px]  majorthree:z-40">
                <h1 className="text-green-500 text-2xl border-solid
                 border-b-2 border-blue-400">Consultoria Online Cuba Personal</h1>
                    <p className="text-white">Com a crescente busca por soluções fitness e bem-estar
...
alcancem seus objetivos de forma flexível e personalizada.
            ...
            <Image src={PersonalBgCut} alt="trainer image" className="w-[220px] majorthree:absolute"/>
            <div className="overlay_about1 flex flex-col w-[400px] majorthree:z-40">
                <h1 className="text-green-500 text-2xl border-solid
                 border-b-2 border-blue-400">Propósito e metas</h1>
                    <p className="text-white">Nosso compromisso é criar um programa de treino
