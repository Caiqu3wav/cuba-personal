  ...
  useLayoutEffect(() => {
    ...
    return (
      <div className="flex w-full min-h-[500px] items-center justify-between">
        <Image src={RunPic} className="w-[35%] rounded-r-xl rounded-br-xl" alt="running services of cuba"/>
        <div id="personal" className="personal-right opacity-0 transition-opacity 
          flex flex-col min-h-[500px] text-center pb-4 items-center justify-center">
        <Image src={CubaLogo} className="w-[100px] midtwo2:w-[60px]" alt="cuba logo" />
          <div className="overlay-personal-right translate-y-[400px] flex flex-col items-center justify-center w-[70%] midfour:w-[86%]
           rounded-xl py-3">
            ...
            <h2 className="flex gap-2 items-center text-mainRed"><span className="text-mainRed">Guaratinguetá - SP</span> 
            <FaMapLocationDot className="text-mainRed" size={30} /> </h2>
