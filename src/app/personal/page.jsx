...
<div className='flex flex-col pb-4'>
    <div className='pt-[37px] ml-4 flex '> <div className='w-[400px]'><h1 className='text-[34px] font-semibold text-green-600 border-solid
    ...
    <Image src={GymLogo} className="gymlogo w-[50px] absolute inset-0 mx-auto" alt="gym logo"/>
</div>
